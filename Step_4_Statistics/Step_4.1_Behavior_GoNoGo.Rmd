...
# Define Errors of commision columns to iterate over
columns_errors <- c("Task_Incorrect_Go", "Task_Incorrect_NoGo", "Ratio_iGo", "Ratio_iNoGo")
# Define all the other columns to iterate over
columns_others <- c("RT_Correct_Go", "RT_Incorrect_NoGo", "Task_Correct_Go", "Task_Correct_NoGo", "Ratio_cGo", "Ratio_cNoGo")
...
write.csv(final_results, file = '/Users/paulamun/Desktop/GoNoGo_Committee_meeting/Analysis_Results.csv', row.names = TRUE)
