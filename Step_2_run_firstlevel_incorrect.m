...
subject_all = {'BITS028', 'BITS033', 'BITS021', 'BITS015', 'BITS062', 'BITS020', 'BITS024', 'BITS027', 'BITS030', 'BITS055', 'BITS056', 'BITS057', 'BITS063', 'BITS054', 'BITS039', 'BITS040', 'BITS031', 'BITS042', 'BITS014', 'BITS026'};
...
TR = 2; nsclices = 32; spike_thresh = 0.25;
 ...
 for ises = 1: length(session_all)
        ...
        out_dir = fullfile(model_dir, ['sub-', subject], ['ses-', session], 'gonogo', 'incorrect')
...
disp(out_dir)
            ...
            gonogo_first_level_incorrect(out_dir, TR, mask, nsclices);
        end
